...
public class CalendarService {
    ...
    public void addEvent(Context context, CallDetails callDetails) {
        ...
        try {
            ...
            int snoozeReminderDuration = EnginizerApplication.PROPERTIES.getInt("enginizer.schedule.default.snooze.time");
            ...
            long eventID = Long.parseLong(insertedEvent.getLastPathSegment());
